...
<head>
<meta charset="UTF-8">
<title>Add image vocabulary</title>
<link rel="stylesheet"
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form method="POST" action="AddImageVocabularyController?vocabularyguidelineid=<%=request.getAttribute("vocabularyguidelineid")%>" enctype="multipart/form-data">
