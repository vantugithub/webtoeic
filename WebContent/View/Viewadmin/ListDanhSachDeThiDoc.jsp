...
<head>
<meta charset="UTF-8">
<title>Thêm dách sách đề thi đọc</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="#">Quản lý phần dách sách đề thi reading</a></li>
						<li class="active">Thêm danh sách đề thi reading</li>
									...
									<table id="simple-table"
										...
										<thead>
											<tr>
												...
												<th class="center">Namereadingexam</th>
												<th class="center">Image</th>
												<th class="center">Delete</th>
												<th class="center">Add content</th>
												<th class="center">Checked</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${listReading}" var="list">
												<tr>
													<td class="center">${list.readexerciseid}</td>
													...
													<td class="center"><a
														href="AddFileExcelReadingController?readexerciseid=${list.readexerciseid}"
														class="green"> <i
			...
			<div class="pagination">
				...
				<ul>
					<c:if test="${numberpage == 1}">
						<a class="w3-button"
							href="HienThiDanhSachDeThiDoc?page=${numberpage+1}">Next</a>
					</c:if>

					<c:if test="${numberpage == maxPage}">
						<a class="w3-button"
							href="HienThiDanhSachDeThiDoc?page=${numberpage-1}">Prev</a>
					</c:if>
...
<!--/.Pagination-->
							...
							<div class="row">
								<div class="col-xs-12">
									<button type="button" class="btn btn-white btn-info btn-bold "
										...
										<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i> Thêm danh sách đề thi reading
									</button>
								</div>
							</div>
						</div>
		...
		<form action="ThemTenDeThiReadingController" method="POST">
			<!-- Modal -->
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="readname">readname</h5>
						...
						<div class="modal-body">
							<label>Nhập name name Reading exam: </label> <input
								id="readname" name="readname" />
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary"
								data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary">Thêm bài reading</button>
						</div>
