			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="#">Quản lý đề thi nghe</a></li>
						<li class="active">Thêm đề thi nghe</li>
							...
							<div class="row">
								<div class="col-xs-12">
									<table id="simple-table"
										...
										<tbody>
									 		<c:forEach items="${listListening}" var="list">
												<tr>
													...
													<td class="center"><a
														href="AddFileExcelListeningController?listenexerciseid=${list.listenexerciseid}"
														class="green"> <i
			...
			<div class="pagination">
				...
				<ul>
					<c:if test="${numberpage == 1}">
						...
						<a class="w3-button"
							href="HienThiDanhSachDeThiNghe?page=${numberpage+1}">Next</a>
					</c:if>

					<c:if test="${numberpage == maxPage}">
						<a class="w3-button"
							href="HienThiDanhSachDeThiNghe?page=${numberpage-1}">Prev</a>
					</c:if>
...
<!--/.Pagination-->
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<a href="AddAudioAndImageListeningController" role="button" class="btn btn-white btn-warning btn-bold">Thêm audio và hình ảnh đề thi</a>
		...
		<form action="AddListeningController" method="POST">
			<!-- Modal -->
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Tên đề thi nghe</h5>
						...
						<div class="modal-body">
							<label>Nhập name đề thi: </label> <input
								id="listenexercisename" name="listenexercisename" />
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary"
								data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary">Thêm đề thi nghe</button>
						</div>
