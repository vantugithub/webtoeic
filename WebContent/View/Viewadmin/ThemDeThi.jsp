							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form method="POST" action="addFileDeThiController?examinationid=<%=request.getAttribute("examinationid")%>" enctype="multipart/form-data">
