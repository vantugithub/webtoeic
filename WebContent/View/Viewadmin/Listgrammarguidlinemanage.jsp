...
<head>
<meta charset="UTF-8">
<title>Thêm danh sách bài hướng dẫn học ngữ pháp</title>
									...
									<table id="simple-table"
										...
										<thead>
											<tr>
												...
												<th class="center">Namegrammar</th>
										...
										<tbody>
											<c:forEach items="${listgrammarguidline}" var="list">
												<tr>
													<td class="center">${list.grammarguidlineid}</td>
													<td class="center">${list.grammarname}</td>
													<td class="center">${list.grammarimage}</td>
													<td class="center"><a class="red" href="deleteController?grammarguidelineid=${list.grammarguidlineid}"> <i
															class="ace-icon fa fa-trash-o bigger-130"></i>
													</a></td>
													<td class="center"><a
														href="Contentforward?id=${list.grammarguidlineid}"
														class="green"> <i
			...
			<div class="pagination">
				...
				<ul>
					<c:if test="${numberpage == 1}">
						...
						<li><a href="ListgrammarguidlinemanageForward?page=1">1</a></li>
						<li><a href="ListgrammarguidlinemanageForward?page=2">2</a></li>
						<li><a
							href="ListgrammarguidlinemanageForward?page=${numberpage+1}">Next</a></li>
					</c:if>

					<c:if test="${numberpage == maxPage}">
						<li><a
							href="ListgrammarguidlinemanageForward?page=${numberpage-1}">Prev</a></li>
						<li><a href="ListgrammarguidlinemanageForward?page=1">1</a></li>
						<li><a href="ListgrammarguidlinemanageForward?page=2">2</a></li>
					</c:if>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<label>Nhập name grammarguideline: </label> <input
								id="nameGrammarguideline" name="grammarName" />
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary"
								data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary">Thêm bài
								hướng dẫn</button>
						</div>
