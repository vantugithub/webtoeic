										...
										<tbody>
											<c:forEach items="${listexam}" var="list">
												<tr>
													...
													<td class="center">${list.examinationage}</td>
													<td class="center"><a class="red" href="#"> <i
															class="ace-icon fa fa-trash-o bigger-130"></i>
													</a></td>
													<td class="center"><a
														href="Themdethi?examinationid=${list.examinationid}"
														class="green"> <i
...
<!--/.Pagination-->
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<a href="AddFileAndAudioController" role="button" class="btn btn-white btn-warning btn-bold">Thêm audio và hình ảnh đề thi</a>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Tên đề thi</h5>
						...
						<div class="modal-body">
							<label>Nhập name đề thi: </label> <input
								id="examinationame" name="examinationame" />
						</div>
