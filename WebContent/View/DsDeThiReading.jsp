				...
				<div class="span6">
					<div class="media">
						<a href="#" class="pull-left"><img
							src="ImageReading/${lis.readimage}" class="media-object" alt='anh'
							width="250" height="100" /></a>
						<div class="media-body">
							<h4 class="media-heading"></h4>
							<p>${lis.readname}</p>
							<a
								href="LamBaiReadingController?readexerciseid=${lis.readexerciseid}&memberid=<%=session.getAttribute("sessionuserid")%>&page=1"
			...
			<div class="pagination">
				...
				<ul>
					<c:if test="${numberPage == 1}">
						...
						<li><a href="ListPhanDocForward?page=1">1</a></li>
						<li><a href="ListPhanDocForward?page=2">2</a></li>
						<li><a
							href="ListPhanDocForward?page=${numberPage+1}">Next</a></li>
					</c:if>

					<c:if test="${numberPage == maxPage}">
						<li><a
							href="ListPhanDocForward?page=${numberPage-1}">Prev</a></li>
						<li><a href="ListPhanDocForward?page=1">1</a></li>
						<li><a href="ListPhanDocForward?page=2">2</a></li>
					</c:if>
