		...
		<c:forEach items="${dapandungbtnghe}" var ="listcorrectanswer">
						<c:if test="${listcorrectanswer.correctanswer == 'A'}">
							<c:if test="${kq == 'A'}">
								...
								<p>
									<img src= "ImageAudioListening/${listcorrectanswer.imagename}" alt="" style="width:250px;height:150px;"/>
								</p>
								<p>
									<audio controls>
										<source src="ImageAudioListening/${listcorrectanswer.audiogg}" type="audio/ogg">
										<source src="ImageAudioListening/${listcorrectanswer.audiomp3}" type="audio/mpeg">
									</audio>
								</p>
								<p>
